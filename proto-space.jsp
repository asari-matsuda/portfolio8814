    ...
    <main class="content">
      ...
      <article class="article">
        <div class="article-inner">
          <p class="article-img"><img src="img/proto-space1.png" alt=""></p>
          <p class="article-img"><img src="img/proto-space2.png" alt=""></p>
          <p class="article-img"><img src="img/proto-space3.png" alt=""></p>
          <p class="article-img"><img src="img/proto-space4.png" alt=""></p>
          <p class="article-img"><img src="img/proto-space5.png" alt=""></p>
          <p class="article-img"><img src="img/proto-space6.png" alt=""></p>
          <div class="article-body">
            <p>
              画像が投稿できるアプリを作成しました。ログイン機能、コメント機能ががついています。
            </p>
            <p>
              シンプルなデザインで写真や説明が映えるようにし、投稿者のプロフィールなど個性を表現できるようなものにしました。
            </p>
            <h3 class="article-info-title">github</h3>
            <p>
              https://github.com/asari-matsuda/protospace-19960814
            </p>
